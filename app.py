...
# Inicialización segura de variables diagnósticas para el expander técnico
...
st.markdown(
    ...
    ".semaforo-card{background:#FFFFFF; border:1px solid #CBD5E1; border-radius:18px; padding:14px 15px; box-shadow:0 4px 14px rgba(15,23,42,.05); min-height:116px; margin
