...
# REGLA DE ORO DE STREAMLIT: set_page_config debe ser la primera instrucción absoluta
...
# Blindaje técnico: Inicialización explícita de variables diagnósticas para la barra lateral/expander
...
# =========================================================
# 2. MOTOR DE CÁLCULO PREVENT (SANEADO - ELIMINA 'tc')
# =========================================================
...
# =========================================================
# 3. INYECCIÓN DE ESTILOS CSS REESTRUCTURADOS (BLINDADO)
# =========================================================
st.markdown(
    "<style>"
    ...
    ".semaforo-card{background:#FFFFFF; border:1px solid #CBD5E1; border-radius:18px; padding:14px 15px; box-shadow:0 4px
